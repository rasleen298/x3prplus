...
<<match2, fig.width=10, fig.height=8, echo=FALSE, warning=FALSE>>=
...
<<match3,  fig.width=10, fig.height=8, echo=FALSE, warning=FALSE>>=
...
{\tt num.lines} is typically on the order of 500, while {\tt num.pts.line} varies a bit around 1550. 
...
each scan covers about 70$^\degree$ of a bullet, while each bullet has a median diameter of about 9,100 $\mu m$.
