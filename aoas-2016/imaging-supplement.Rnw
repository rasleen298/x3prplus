...
imgdir <- "figure"
codedir <- "code"
datadir <- "images/Hamby252_3DX3P1of2/"
...
knowndatadir <- "images/Hamby252_3DX3P1of2/"
unknowndatadir <- "images/Hamby252_3DX3P2of2/"
...
bstats <- read.csv("data/data-25-25/bullet-stats.csv", stringsAsFactors = FALSE)
