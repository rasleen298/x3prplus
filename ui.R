...
shinyUI(fluidPage(theme = shinytheme("cerulean"),
    ...
    sidebarLayout(
        sidebarPanel(width = 3,
            ...
            sliderInput("xcoord1", "X Coordinate (First Land)", min = 1, max = 1000, value = 136, step = 1),
            sliderInput("xcoord2", "X Coordinate (Second Land)", min = 1, max = 1000, value = 636, step = 1),
